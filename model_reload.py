...
if __name__ == "__main__":                          #hyperparameters assignment
    ...
    BATCH_SIZE = 8
    data_path = "data" 
    Model_Save_path = "Models2/model_checkpoint.pth"  
    ...
    checkpoint = torch.load("Models/model_checkpoint.pth", map_location=device)
    ...
    print(f"Model loaded from epoch {epoch_loaded+1}...")
    ...
    #training loop 
    for epoch in tqdm(range(epoch_loaded+1, EPOCHS+epoch_loaded+1)):
        model.train()
        train_loss = 0
